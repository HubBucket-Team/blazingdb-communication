...
public:
  ...
  ConcreteManager(int communicationTcpPort)
...
Manager::Make(int communicationTcpPort) {
  return std::unique_ptr<Manager>{new ConcreteManager(communicationTcpPort)};
}

std::unique_ptr<Manager>
Manager::Make(int communicationTcpPort, const std::vector<Node>& nodes) {
  return std::unique_ptr<Manager>{
      new ConcreteManager{communicationTcpPort, nodes}};
}
